...
KER_PURE_INLINE u32 f32_get_sign_from_u32(const u32 u) {
    return (u & FLT_SIGN_MASK_U32) >> FLT_SIGN_SHIFT_U32;
}

KER_PURE_INLINE u32 f32_get_exp_from_u32(const u32 u) {
    return (u & FLT_EXP_MASK_U32) >> FLT_EXP_SHIFT_U32;
}

KER_PURE_INLINE u32 f32_get_frac_from_u32(const u32 u) {
    return (u & FLT_FRAC_MASK_U32) >> FLT_FRAC_SHIFT_U32;
}

KER_PURE_INLINE i32 f32_get_unbiased_exp_from_u32(const u32 u) {
...
KER_PURE_INLINE u64 f64_get_sign_from_u64(const u64 u) {
    return (u & DBL_SIGN_MASK_U64) >> DBL_SIGN_SHIFT_U64;
}

KER_PURE_INLINE u64 f64_get_exp_from_u64(const u64 u) {
    return (u & DBL_EXP_MASK_U64) >> DBL_EXP_SHIFT_U64;
}

KER_PURE_INLINE u64 f64_get_frac_from_u64(const u64 u) {
    return (u & DBL_FRAC_MASK_U64) >> DBL_FRAC_SHIFT_U64;
}

KER_PURE_INLINE i32 f64_get_unbiased_exp_from_u64(const u64 u) {
