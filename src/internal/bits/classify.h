...
KER_PURE_INLINE bool f32_is_qnan_from_u32(const u32 u) {
...
KER_PURE_INLINE bool f32_is_pos_zero_from_u32(const u32 u) {
...
KER_PURE_INLINE bool f32_is_neg_zero_from_u32(const u32 u) {
...
KER_PURE_INLINE bool f32_is_pos_inf_from_u32(const u32 u) {
...
KER_PURE_INLINE bool f32_is_neg_inf_from_u32(const u32 u) {
...
KER_PURE_INLINE bool f32_is_pos_qnan_from_u32(const u32 u) {
...
KER_PURE_INLINE bool f32_is_neg_qnan_from_u32(const u32 u) {
    return BOOL((u & FLT_ABS_MASK_U32) > FLT_EXP_MASK_U32 && (u & FLT_QNAN_BIT_U32) && (u & FLT_SIGN_MASK_U32));
}
...
KER_PURE_INLINE bool f32_is_pos_snan_from_u32(const u32 u) {
    return BOOL((u & FLT_ABS_MASK_U32) > FLT_EXP_MASK_U32 && !(u & FLT_QNAN_BIT_U32) && !(u & FLT_SIGN_MASK_U32));
}
...
KER_PURE_INLINE bool f32_is_neg_snan_from_u32(const u32 u) {
    return BOOL((u & FLT_ABS_MASK_U32) > FLT_EXP_MASK_U32 && !(u & FLT_QNAN_BIT_U32) && (u & FLT_SIGN_MASK_U32));
}
...
KER_PURE_INLINE bool f64_is_qnan_from_u64(const u64 u) {
...
KER_PURE_INLINE bool f64_is_pos_zero_from_u64(const u64 u) {
...
KER_PURE_INLINE bool f64_is_neg_zero_from_u64(const u64 u) {
...
KER_PURE_INLINE bool f64_is_pos_inf_from_u64(const u64 u) {
...
KER_PURE_INLINE bool f64_is_neg_inf_from_u64(const u64 u) {
...
KER_PURE_INLINE bool f64_is_pos_qnan_from_u64(const u64 u) {
...
KER_PURE_INLINE bool f64_is_neg_qnan_from_u64(const u64 u) {
    return BOOL((u & DBL_ABS_MASK_U64) > DBL_EXP_MASK_U64 && (u & DBL_QNAN_BIT_U64) && (u & DBL_SIGN_MASK_U64));
}
...
KER_PURE_INLINE bool f64_is_pos_snan_from_u64(const u64 u) {
    return BOOL((u & DBL_ABS_MASK_U64) > DBL_EXP_MASK_U64 && !(u & DBL_QNAN_BIT_U64) && !(u & DBL_SIGN_MASK_U64));
}
...
KER_PURE_INLINE bool f64_is_neg_snan_from_u64(const u64 u) {
    return BOOL((u & DBL_ABS_MASK_U64) > DBL_EXP_MASK_U64 && !(u & DBL_QNAN_BIT_U64) && (u & DBL_SIGN_MASK_U64));
}
