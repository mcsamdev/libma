 ...
 */
LIBMA_ALWAYS_INLINE_STATIC bool flt_isnan_u32(const uint32_t u) {
 ...
 */
LIBMA_ALWAYS_INLINE_STATIC bool flt_isinf_u32(const uint32_t u) {
 ...
 */
LIBMA_ALWAYS_INLINE_STATIC bool flt_isfinite_u32(const uint32_t u) {
 ...
 */
LIBMA_ALWAYS_INLINE_STATIC bool flt_iszero_u32(const uint32_t u) {
 ...
 */
LIBMA_ALWAYS_INLINE_STATIC bool flt_issubnormal_u32(const uint32_t u) {
 ...
 */
LIBMA_ALWAYS_INLINE_STATIC float flt_copysign(const float x, const float y) {
    uint32_t ux = flt_to_u32(x);
    uint32_t uy = flt_to_u32(y);
    ux = (ux & ~FLT_SIGN_MASK) | (uy & FLT_SIGN_MASK);
    return u32_to_flt(ux);
}
 ...
 */
LIBMA_ALWAYS_INLINE_STATIC float flt_fabs(const float x) {
 ...
 */
LIBMA_ALWAYS_INLINE_STATIC float flt_neg(const float x) {
    uint32_t u = flt_to_u32(x);
    u ^= FLT_SIGN_MASK;
    return u32_to_flt(u);
}
 ...
 */
LIBMA_ALWAYS_INLINE_STATIC uint32_t flt_quiet_nan_u32(const uint32_t u) {
    return u | (1u << 22);
}
 ...
 */
LIBMA_ALWAYS_INLINE_STATIC int dbl_isnan_u64(const uint64_t u) {
 ...
 */
LIBMA_ALWAYS_INLINE_STATIC int dbl_isinf_u64(const uint64_t u) {
 ...
 */
LIBMA_ALWAYS_INLINE_STATIC int dbl_isfinite_u64(const uint64_t u) {
 ...
 */
LIBMA_ALWAYS_INLINE_STATIC int dbl_iszero_u64(const uint64_t u) {
 ...
 */
LIBMA_ALWAYS_INLINE_STATIC int dbl_issubnormal_u64(const uint64_t u) {
 ...
 */
LIBMA_ALWAYS_INLINE_STATIC double dbl_copysign(double x, double y) {
    uint64_t ux = dbl_to_u64(x);
    const uint64_t uy = dbl_to_u64(y);
    ux = (ux & ~DBL_SIGN_MASK) | (uy & DBL_SIGN_MASK);
    return u64_to_dbl(ux);
}
 ...
 */
LIBMA_ALWAYS_INLINE_STATIC double dbl_fabs(double x) {
 ...
 */
LIBMA_ALWAYS_INLINE_STATIC double dbl_neg(const double x) {
    uint64_t u = dbl_to_u64(x);
    u ^= DBL_SIGN_MASK;
    return u64_to_dbl(u);
}
 ...
 */
LIBMA_ALWAYS_INLINE_STATIC uint64_t dbl_quiet_nan_u64(const uint64_t u) {
    return u | (1ULL << 51);
}
 ...
 */
LIBMA_ALWAYS_INLINE_STATIC int flt_isnan(const float x) {
    return flt_isnan_u32(flt_to_u32(x));
}
 ...
 */
LIBMA_ALWAYS_INLINE_STATIC int flt_isinf(const float x) {
    return flt_isinf_u32(flt_to_u32(x));
}
 ...
 */
LIBMA_ALWAYS_INLINE_STATIC int flt_isfinite(const float x) {
    return flt_isfinite_u32(flt_to_u32(x));
}
 ...
 */
LIBMA_ALWAYS_INLINE_STATIC int flt_iszero(const float x) {
    return flt_iszero_u32(flt_to_u32(x));
}
 ...
 */
LIBMA_ALWAYS_INLINE_STATIC int flt_issubnormal(const float x) {
    return flt_issubnormal_u32(flt_to_u32(x));
}
 ...
 */
LIBMA_ALWAYS_INLINE_STATIC int dbl_isnan(const double x) {
    return dbl_isnan_u64(dbl_to_u64(x));
}
 ...
 */
LIBMA_ALWAYS_INLINE_STATIC int dbl_isinf(const double x) {
    return dbl_isinf_u64(dbl_to_u64(x));
}
 ...
 */
LIBMA_ALWAYS_INLINE_STATIC int dbl_isfinite(const double x) {
    return dbl_isfinite_u64(dbl_to_u64(x));
}
 ...
 */
LIBMA_ALWAYS_INLINE_STATIC int dbl_iszero(const double x) {
    return dbl_iszero_u64(dbl_to_u64(x));
}
 ...
 */
LIBMA_ALWAYS_INLINE_STATIC int dbl_issubnormal(const double x) {
    return dbl_issubnormal_u64(dbl_to_u64(x));
}
